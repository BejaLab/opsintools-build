...
fasta = 'analysis/clustering/5_clustered_sequences.fasta'
clstr = 'analysis/clustering/5_clustered_sequences.fasta.clstr'
...
with open('analysis/clustering/temp/representative_to_del.txt', 'w') as f:
    for i in representative_delete:
        f.write(f"{i}\n")

# Create a text file with the missing reference sequences
with open('analysis/clustering/temp/references_to_add.txt', 'w') as f:
